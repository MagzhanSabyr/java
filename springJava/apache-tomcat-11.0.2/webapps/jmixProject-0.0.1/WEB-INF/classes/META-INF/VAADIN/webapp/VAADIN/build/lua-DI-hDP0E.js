...
`}),ace.define("ace/snippets/lua",["require","exports","module","ace/snippets/lua.snippets"],function(t,e,n){e.snippetText=t("./lua.snippets"),e.scope="lua"}),function(){ace.require(["ace/snippets/lua"],function(t){r&&(r.exports=t)})}()})(i);var s=i.exports;const f=a(s),c=u({__proto__:null,default:f},[s]);export{c as l};
