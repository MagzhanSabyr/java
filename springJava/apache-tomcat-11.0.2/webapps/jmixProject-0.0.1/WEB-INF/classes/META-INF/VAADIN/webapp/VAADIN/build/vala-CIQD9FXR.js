...
`,name:"namespace (ns)",scope:"vala",tabTrigger:"ns"},{content:"stdout.printf($0);",name:"printf",scope:"vala",tabTrigger:"printf"},{content:`\${1:public} \${2:Type} \${3:Name} {
	...
	$0
}`,name:"while",scope:"vala",tabTrigger:"while"}],e.scope=""}),function(){ace.require(["ace/snippets/vala"],function(n){t&&(t.exports=n)})}()})(c);var i=c.exports;const p=s(i),$=l({__proto__:null,default:p},[i]);export{$ as v};
